...
import { BrokerApi, DeviceApiModel } from "smeiot-client";
...
export interface IDeviceStatusCard extends WithStyles<typeof styles> {
...
const _DeviceStatusCard: React.FunctionComponent<IDeviceStatusCard> = ({ classes, device }) => {
  const intl = useIntl();
...
const DeviceStatusCard = withStyles(styles)(_DeviceStatusCard);
