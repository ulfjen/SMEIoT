...
export interface IDashboardNewDeviceProps extends RouteComponentProps, WithStyles<typeof styles> {
  
}


const _DashboardNewDevice: React.FunctionComponent<IDashboardNewDeviceProps> = ({ classes }) => {
