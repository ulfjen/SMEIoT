...
namespace SMEIoT.IntegrationsTests.Helpers
{
  ...
  {
    public static async Task InitializeDbForTestsAsync(ApplicationDbContext db, UserManager<User> userManager)
    {
    ...
    public static async Task ReinitializeDbForTestsAsync(ApplicationDbContext db, UserManager<User> userManager)
    {
      ...
      await InitializeDbForTestsAsync(db, userManager);
    }
  }
